...
// project URL
define('PROJECT_URL', 'https://github.com/pramonoutomo/pawNodeMonitor');

// URL to get version of latest release from github
define('GITHUB_LATEST_API_URL', 'https://api.github.com/repos/pramonoutomo/pawNodeMonitor/releases/latest');
